...
export default function Theoretical({ topic , email}) {
    ...
    return (
        ...
        questionNO == 6 ? (
            <Technical totalScore={totalScore} maxScore={maxScore} questionNO={questionNO} topic={topic} email={email}></Technical>
