                                ...
                                >
                                    ...
                                    <div className="mt-6 flex justify-between items-center">
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-300 ${job.is_saved ? "text-red-500 bg-gray-200" : "text-gray-600 bg-gray-100"
                                                }`}
                                        >
                                            <FaHeart className={`inline-block mr-1 ${job.is_saved ? "text-red-500" : "text-gray-400"}`} />
